...
if (isset($_POST['save'])) {
    ...
    /* here the user can update this firstname, lastname and email address*/
    $sql = "UPDATE users SET firstname = '$fname', lastname='$lname' WHERE user_id='$userid'";
    if (mysqli_query($con, $sql)) {
        /* the table users is sucessfully updated with the new changed in the database*/
...
if (isset($_POST['but_upload'])) {
    ...
    if (in_array($imageFileType, $extensions_arr)) {
        ...
        // Insert new record for names
        $query = "UPDATE users SET profile_path = '$name' WHERE user_id='$userid'";
        mysqli_query($con, $query);

        //The user can upload his own photo by using the Library Folder in his PC
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-right" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="add_expense.php" class="list-group-item list-group-item-action "><span data-feather="plus-circle"></span><b> Add Your Expenses</b></a>
                    ...
                    <hr>
                        <form class="form" method="post" action="" enctype='multipart/form-data'>
                            <div class="text-center mt-3">
                                <img src="<?php echo $userprofile; ?>" class="text-center img img-fluid rounded-circle avatar" width="100" alt="Profile Picture">
                            </div>
                            <div class="input-group col-md mb-3 mt-3">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="profilepic">Change My Profile Picture</label>
                                </div>
                                <div class="input-group-append">
                                    <!-- after clicking on the upload button, the new profile picture is uploaded-->
                                    <button class="btn btn-secondary" type="submit" name='but_upload' id="profilepicinput">Upload Photo</button>
                                </div>
                            </div>
                        ...
                        <form class="form" action="" method="post" id="registrationForm" autocomplete="off">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md">
                                            ...
                                            <input type="text" class="form-control" name="last_name" id="last_name" value="<?php echo $lastname; ?>" placeholder="Surname">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md">
                                    <br>
                                    <!--after clicking the Save Changes button, the new data and profile picture is displayed-->
